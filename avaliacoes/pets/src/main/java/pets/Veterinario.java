...
/**
 * Classe Veterinario representa um veterinário, que é uma extensão da classe
 * Pessoa.
 * Ela possui um CRV (Cadastro de Registro de Veterinário) e métodos para
 * acessar e modificar esse atributo
...
public class Veterinario extends Pessoa {
     ...
     * Sobrescreve o método getInfo da classe Pessoa para incluir o CRV do
     * veterinário.
     * 
