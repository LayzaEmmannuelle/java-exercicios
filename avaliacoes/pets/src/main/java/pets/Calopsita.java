 ...
 * Ela possui um construtor que recebe o nome e a data de nascimento da
 * calopsita,
 * além de um método para obter informações formatadas sobre a calopsita e um
 * método para simular o som da calopsita.
 * 
 * @author João Victor Tavares Fróes
 * @version 1.0
 */
public class Calopsita extends Pet {
    /**
     * Construtor da classe Calopsita.
     * Cria uma nova instância de Calopsita com o nome e data de nascimento
     * fornecidos.
     * 
     * @param nome       o nome da calopsita
     * @param nascimento a data de nascimento da calopsita
     */
    public Calopsita(String nome, String nascimento) {
