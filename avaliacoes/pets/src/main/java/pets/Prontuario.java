...
/**
 * A classe Prontuario representa o prontuário de um pet, contendo informações
 * sobre a consulta realizada.
 * Ela inclui a data da consulta, comentários, o veterinário responsável e o pet
 * associado.
 * 
...
public class Prontuario {
     ...
     */
    public Prontuario(String data, String comentario) {
        this.data = data;
        this.comentario = comentario;
    }

    /**
     * Método para realizar uma consulta associando um veterinário e um pet ao
     * prontuário.
     * Este método imprime uma mensagem indicando que a consulta foi realizada para
     * o pet pelo veterinário.
     * 
     * @param veterinario
     * @param pet
     */
    public void realizarConsulta(Veterinario veterinario, Pet pet) {
        this.veterinario = veterinario;
        this.pet = pet;
