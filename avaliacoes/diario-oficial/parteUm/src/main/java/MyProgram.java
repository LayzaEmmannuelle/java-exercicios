...
public class MyProgram {
     ...
     * Cria órgãos, publicações com blocos de texto e monta um Diário Oficial para impressão.
     *
    ...
    /**
     * Cria e retorna uma lista de blocos que compõem a primeira publicação.
     * Cada bloco representa um trecho de texto da publicação.
     *
     * @return lista de blocos da publicação um
     */
    ...
    /**
     * Cria e retorna uma lista de blocos que compõem a segunda publicação.
     * Cada bloco representa um trecho de texto da publicação.
     *
     * @return lista de blocos da publicação dois
     */
